...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/images/general/ba1.jpg" class="d-block w-100 welcome-image" alt="...">
            ...
            <div class="carousel-item">
                <img src="assets/images/general/ba2.jpg" class="d-block w-100 welcome-image" alt="...">
                <div class="welcome-content">
                    <h1 class="mb-0">Conferencia</h1>
                    <h1>Buenos Aires</h1>
                    <p>Llega por primera vez a Argentina un evento para compartir con nuestra comunidad el conocimiento y experiencia de los expertos que están creando el futuro de Internet. Ven a conocer a miembros del evento, a otros estudiantes de Codo a Codo y los oradores de primer nivel que tenemos para ti. ¡Te esperamos!</p>
            ...
            <div class="carousel-item">
                <img src="assets/images/general/ba3.jpg" class="d-block w-100 welcome-image" alt="...">
                <div class="welcome-content">
                    <h1 class="mb-0">Conferencia</h1>
                    <h1>Buenos Aires</h1>
                    <p>Llega por primera vez a Argentina un evento para compartir con nuestra comunidad el conocimiento y experiencia de los expertos que están creando el futuro de Internet. Ven a conocer a miembros del evento, a otros estudiantes de Codo a Codo y los oradores de primer nivel que tenemos para ti. ¡Te esperamos!</p>
            ...
            <div class="row row-cols-1 row-cols-md-3">
                <div class="col mb-4 mb-md-0">
                    <div class="card h-100">
                        <img src="assets/images/general/steve.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col mb-4 mb-md-0">
                    <div class="card h-100">
                        <img src="assets/images/general/bill.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card h-100">
                        <img src="assets/images/general/ada.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
    ...
    <section class="row row-cols-1 row-cols-lg-2 g-0 mt-5" id="lugarYFecha">
        <img src="assets/images/general/honolulu.jpg" alt="">
