...
<header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <a class="navbar-brand text-white ms-5" href="index.php">
            <img src="https://cdn.nicolascalcagno.dev/shared/conferencia-buenos-aires/images/general/codoacodo.webp" alt="Logo" width="100" height="60" class="d-inline-block align-text-center">
